...
* The original package name 'com.example.real-time-order-processing.real-time-order-processing' is invalid and this project uses 'com.example.real_time_order_processing.real_time_order_processing' instead.
